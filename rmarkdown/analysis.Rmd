...
The chosen bin widths are consistent with those using in the equivalent python version of this analysis ([pydesrap_mms](https://github.com/pythonhealthdatascience/pydesrap_mms/)).
