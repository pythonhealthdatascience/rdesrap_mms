...
To enable comparison between the python and R m/m/s models, this section runs the model with a simple set of base case parameters (matched to Python), and then running some scenarios on top of that base case.
