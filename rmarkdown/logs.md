...
```
    ...
    ##  [1] "Parameters:"                                                                                                                                                                                                                             
    ##  [2] "patient_inter=6; mean_n_consult_time=8; number_of_nurses=1; warm_up_period=0; data_collection_period=30; number_of_runs=1; scenario_name=NULL; log_to_console=TRUE; log_to_file=TRUE; file_path=../outputs/logs/log_example.log; cores=1"
    ##  [3] "Log:"                                                                                                                                                                                                                                    
