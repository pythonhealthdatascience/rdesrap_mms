...
To check the stability of the suggested number of replications, run again with a new set of seeds using `seed_offset`.
...
Given the variations observed using the algorithm in the sensitivity analysis, decided appropriate number of replications to be **25**.
...
>
> The user will specify **look_ahead** - as noted in [sim-tools](https://sim-tools.github.io/sim-tools/04_replications/01_automated_reps.html), this is recommended to be **5** by [Hoad et al. (2010)](https://www.jstor.org/stable/40926090).
>
