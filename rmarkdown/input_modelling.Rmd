...
We can create a version of our histograms from before but with the distributions overlaid, to visually support this. The simplest way to do this is to just use the plotting functions from `distfitrplus`.
