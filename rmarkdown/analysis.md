...
```
    ...
    ## 1 count_unseen_nurse                     25  0.16   0.8       -0.170    0.490
    ## 2 mean_patients_in_service               25  2.61   0.0623     2.59     2.64 
    ## 3 mean_queue_length_nurse                25  0.129  0.0234     0.119    0.139
    ## 4 mean_serve_time_nurse                  25 10.0    0.151      9.97    10.1  
    ## 5 mean_time_in_system                    25 10.5    0.179     10.5     10.6  
    ## 6 mean_waiting_time_nurse                25  0.515  0.0876     0.479    0.551
    ## 7 mean_waiting_time_unseen_nurse          1  8.18  NA         NA       NA    
    ## 8 utilisation_nurse                      25  0.497  0.00994    0.493    0.501
...
```
    ...
    ##   \hline
    ## 1 &   3 & 0.67 (0.66, 0.67) & 0.56 (0.55, 0.56) & 0.48 (0.47, 0.48) & 0.42 (0.41, 0.42) \\ 
    ##   2 &   4 & 0.50 (0.49, 0.50) & 0.42 (0.41, 0.42) & 0.36 (0.35, 0.36) & 0.31 (0.31, 0.31) \\ 
    ##   3 &   5 & 0.40 (0.39, 0.40) & 0.33 (0.33, 0.33) & 0.28 (0.28, 0.29) & 0.25 (0.25, 0.25) \\ 
    ##   4 &   6 & 0.33 (0.33, 0.33) & 0.28 (0.27, 0.28) & 0.24 (0.23, 0.24) & 0.21 (0.20, 0.21) \\ 
    ##   5 &   7 & 0.28 (0.28, 0.29) & 0.24 (0.23, 0.24) & 0.20 (0.20, 0.20) & 0.18 (0.18, 0.18) \\ 
    ##    \hline
    ## \end{tabular}
    ## \end{table}
...
```
    ...
    ##   replication arrivals mean_patients_in_service mean_queue_length_nurse
    ##         <int>    <int>                    <dbl>                   <dbl>
    ## 1           1     4991                     1.99                  0.0362
    ## 2           2     4975                     2.00                  0.0456
    ## 3           3     5049                     2.05                  0.0386
    ## 4           4     4996                     2.07                  0.0473
    ## 5           5     4922                     2.00                  0.0410
    ## 6           6     5136                     2.12                  0.0545
...
```
    ...
    ## 1 patie…     30236.       NA            NA nurse             25            45262
    ## 2 patie…     30237.       NA            NA nurse             25            45263
    ## 3 patie…     30237.       NA            NA nurse             25            45264
    ## 4 patie…     30238.       NA            NA nurse             25            45265
    ## 5 patie…     30238.       NA            NA nurse             25            45266
    ## 6 patie…     30239.       NA            NA nurse             25            45267
