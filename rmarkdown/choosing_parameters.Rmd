...
It's important to check ahead, to check that the 5% precision is maintained - as evident in this case, where we see:

* < 5% at 3 replications, but this is not maintained.
* Consistently <5% from 99 replications onwards (hence suggested `min_rep = 100`).
