...
For each replication, find the average result per interval in the simulation.
...
Run function which calculates and plots cumulative results for each metric. Run on all except unseen counts (as those are just 0 / NA for this model).
